...
@section('main-content')	
	<div class="row" id="sectionApp">
        ...
        <div class="col-md-12">@include('includes.button-create',['permission'=>'accounts_create', 'url'=>route('accounts.create')])</div>
        @include('includes.delete-modal',['permission'=>'accounts_delete'])
	</div>
@endsection
