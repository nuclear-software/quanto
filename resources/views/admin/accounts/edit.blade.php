...
@section('main-content')
	<div class="row" id="sectionApp" v-cloak>
		<div class="col-md-12">
			...
			<form id="form-section" action="{{ route('accounts.update', $account->id) }}" method="POST" enctype="multipart/form-data" @submit.prevent="validateBeforeSubmit">
				<input type="hidden" name="_method" value="PUT">
				<input type="hidden" name="_token" value="{{ csrf_token() }}">
                <div class="row">
    				<div class="col-md-12">@include('HTML_VUE.input_text',[ 'label'=>'Establishment Table Id', 'placeholder'=>'Establishment Table Id', 'model'=>'establishment_table_id', 'name'=>"'establishment_table_id'", 'validate'=>"'required'"])</div>
    ...
    <script type="text/javascript">
        ...
        var section = new Vue({
            ...
            data: {
            	...
            	establishment_table_id:`{!!old('establishment_table_id')!!}` 
