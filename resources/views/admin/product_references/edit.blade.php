...
@section('main-content')
	<div class="row" id="sectionApp" v-cloak>
		<div class="col-md-12">
			...
			<form id="form-section" action="{{ route('product_references.update', $product_reference->id) }}" method="POST" enctype="multipart/form-data" @submit.prevent="validateBeforeSubmit">
