...
@section('main-content')	
	<div class="row" id="sectionApp">
        ...
        <div class="col-md-12">@include('includes.button-create',['permission'=>'product_references_create', 'url'=>route('product_references.create')])</div>
        @include('includes.delete-modal',['permission'=>'product_references_delete'])
	</div>
@endsection
@section('local-script')
    ...
    <script type="text/javascript">
        ...
        var section = new Vue({
            el: '#sectionApp',
            data:{
                base_url: '{{route('product_references.index')}}',
                to_delete: null
            },
            methods:{
                delete(e){
