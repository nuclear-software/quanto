...
@section('main-content')	
	<div class="row" id="sectionApp">
        ...
        <div class="col-md-12">@include('includes.button-create',['permission'=>'products_create', 'url'=>route('products.create')])</div>
        @include('includes.delete-modal',['permission'=>'products_delete'])
	</div>
@endsection
