...
@section('main-content')
	<div class="row" id="sectionApp" v-cloak>
		<div class="col-md-12">
			...
			<form id="form-section" action="{{ route('establishments.update', $establishment->id) }}" method="POST" enctype="multipart/form-data" @submit.prevent="validateBeforeSubmit">
                ...
                <div class="row">
    				...
    				<div class="col-md-12">@include('HTML_VUE.input_text',[ 'label'=>'Location', 'placeholder'=>'Location', 'model'=>'location', 'name'=>"'location'", 'validate'=>"'required'"])</div>
