...
@section('main-content')
	<div class="row" id="sectionApp" v-cloak>
		<div class="col-md-12">
			...
			<form id="form-section" action="{{ route('account_components.update', $account_component->id) }}" method="POST" enctype="multipart/form-data" @submit.prevent="validateBeforeSubmit">
				<input type="hidden" name="_method" value="PUT">
				<input type="hidden" name="_token" value="{{ csrf_token() }}">
                <div class="row">
    				<div class="col-md-12">@include('HTML_VUE.input_text',[ 'label'=>'Account Id', 'placeholder'=>'Account Id', 'model'=>'account_id', 'name'=>"'account_id'", 'validate'=>"'required'"])</div>
    				<div class="col-md-12">@include('HTML_VUE.input_text',[ 'label'=>'Estado', 'placeholder'=>'Estado', 'model'=>'estado', 'name'=>"'estado'", 'validate'=>"'required'"])</div>
