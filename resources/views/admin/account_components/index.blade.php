...
@section('main-content')	
	<div class="row" id="sectionApp">
        ...
        <div class="col-md-12">@include('includes.button-create',['permission'=>'account_components_create', 'url'=>route('account_components.create')])</div>
        @include('includes.delete-modal',['permission'=>'account_components_delete'])
	</div>
@endsection
@section('local-script')
    ...
    <script type="text/javascript">
        ...
        var section = new Vue({
            el: '#sectionApp',
            data:{
                base_url: '{{route('account_components.index')}}',
                to_delete: null
            },
            methods:{
                delete(e){
