...
@section('main-content')	
	<div class="row" id="sectionApp">
        ...
        <div class="col-md-12">@include('includes.button-create',['permission'=>'memberships_create', 'url'=>route('memberships.create')])</div>
        @include('includes.delete-modal',['permission'=>'memberships_delete'])
	</div>
@endsection
@section('local-script')
    ...
    <script type="text/javascript">
        ...
        var section = new Vue({
            el: '#sectionApp',
            data:{
                base_url: '{{route('memberships.index')}}',
                to_delete: null
            },
            methods:{
                delete(e){
