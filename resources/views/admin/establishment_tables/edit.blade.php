...
@section('main-content')
	<div class="row" id="sectionApp" v-cloak>
		<div class="col-md-12">
			...
			<form id="form-section" action="{{ route('establishment_tables.update', $establishment_table->id) }}" method="POST" enctype="multipart/form-data" @submit.prevent="validateBeforeSubmit">
				<input type="hidden" name="_method" value="PUT">
				<input type="hidden" name="_token" value="{{ csrf_token() }}">
                <div class="row">
    				<div class="col-md-12">@include('HTML_VUE.input_text',[ 'label'=>'Establishment Id', 'placeholder'=>'Establishment Id', 'model'=>'establishment_id', 'name'=>"'establishment_id'", 'validate'=>"'required'"])</div>
